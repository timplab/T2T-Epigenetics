...
regs <- read_tsv(paste0(dat, "/TE/revision/chr19-L1HS-HORembed.bed"), col_names = T) %>%
...
ggsave(
  paste0(figs,"CHM13_CEN19_metaplotREV_normalized.pdf"),
  plot = p,
  scale = 1,
  width = 12,
  height = 5,
...
ggsave(
  paste0(figs,"CHM13_CEN19_metaplotREV_normalized_withCpGbar.pdf"),
  plot = last_plot(),
  scale = 1,
  width = 12,
  height = 8,
