...
regs <- read_tsv(paste0(dat, "/TE/revision/chr3_cen-TEisland_chm13v1.0.bed"), col_names = T) %>%
...
ggsave(
  paste0(figs,"CHM13_CEN3_metaplotREV_normalized.pdf"),
  plot = p,
  scale = 1,
  width = 12,
  height = 5,
...
ggsave(
  paste0(figs,"CHM13_CEN3_metaplotREV_normalized_withCpGbar.pdf"),
  plot = last_plot(),
  scale = 1,
  width = 12,
  height = 8,
