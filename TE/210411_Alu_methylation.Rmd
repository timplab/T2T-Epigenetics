...
#    )
#
#saveRDS(cpg.dist, paste0(dat, "/TE/Alu-SINE_chm13v1_polish-033121_CpG_dist100bp.rds"))

cpg.dist <- readRDS(paste0(dat, "/TE/Alu-SINE_chm13v1_polish-033121_CpG_dist.rds"))
...
ggsave(
  paste0(dat, "/figures/evol_meth/TE/","Alu_YvsSvsJ_PercDiv100bp.pdf"),
  plot = plot1,
  scale = 1,
  width = 15,
  height = 10,
...
ggsave(
  paste0(dat, "/figures/evol_meth/TE/","Alu_YvsSvsJ_CpG_KWtest.pdf"),
  plot = last_plot(),
  scale = 1,
  width = 5,
  height = 5,
...
ggsave(
  paste0(dat, "/figures/evol_meth/TE/","Alu_YvsSvsJ_average_methylation_frequency_KWtest.pdf"),
  plot = last_plot(),
  scale = 1,
  width = 5,
  height = 5,
...
ggsave(
  paste0(dat, "/figures/evol_meth/TE/","Alu_hot_not_100bp.pdf"),
  plot = plot1,
  scale = 1,
  width = 15,
  height = 10,
...
ggsave(
  paste0(dat, "/figures/evol_meth/TE/","Alu_hotvsnot_CpG_KWtest.pdf"),
  plot = last_plot(),
  scale = 1,
  width = 5,
  height = 5,
...
ggsave(
  paste0(dat, "/figures/evol_meth/TE/","Alu_hotvsnot_average_methylation_frequency_KWtest.pdf"),
  plot = last_plot(),
  scale = 1,
  width = 5,
  height = 5,
