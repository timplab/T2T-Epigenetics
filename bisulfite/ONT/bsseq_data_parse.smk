...
#samples_tb = [f.split(".")[0] for f in os.listdir(config['workdir']) if f.endswith(".fq.gz ")]
samples_tb="004_0111_001_"
...
rule bismark_align_pe:
  input:
        R1=config['workdir']+"/{sample}R1_val_1.fq.gz",
        R2=config['workdir']+"/{sample}R2_val_2.fq.gz",
